...
namespace gpstk
{
      ...
      throw(SatIDNotFound)
   {
      ...
      // Returns a SourceIDSet with all the sources present in this object.
   SourceIDSet sourceValueMap::getSourceID() const
   {
      ...
      // Returns a Vector with all the sources present in this object.
   Vector<SourceID> sourceValueMap::getVectorOfSourceID() const
   {
      ...
      // Returns a sourceValueMap with only this source.
   ...
   sourceValueMap sourceValueMap::extractSourceID(const SourceID& source) const
   {
      ...
      // Returns a sourceValueMap with only these sources.
...
//       * the same number of type values.
//       */
//   size_t satOrbitMap::numElements() const
//   {
//
//      size_t numEle(0);
//
//      for( satOrbitMap::const_iterator it = (*this).begin();
//           it != (*this).end();
//           ++it )
//      {
//         numEle = numEle + (*it).second.size();
...
//      return numEle;
//
//   }  // End of method 'satOrbitMap::numElements()'
//
//
//
//      // Returns a SatIDSet with all the satellites present in this object.
//   SatIDSet satOrbitMap::getSatID() const
//   {
//
//      SatIDSet satSet;
//
//      for( satOrbitMap::const_iterator pos = (*this).begin();
//           pos != (*this).end();
//           ++pos )
//      {
//         satSet.insert( (*pos).first );
...
//      return satSet;
//
//   }  // End of method 'satOrbitMap::getSatID()'
//
//
//
//      // Returns a Vector with all the satellites present in this object.
//   Vector<SatID> satOrbitMap::getVectorOfSatID() const
//   {
//
//      std::vector<SatID> temp;
//
...
//      return result;
//
//   }  // End of method 'satOrbitMap::getVectorOfSatID()'
//
//
//
//      // Returns a satOrbitMap with only this satellite.
//      // @param satellite Satellite to be extracted.
//   satOrbitMap satOrbitMap::extractSatID(const SatID& satellite) const
//   {
//
//      SatIDSet satSet;
//      satSet.insert(satellite);
...
//      return extractSatID(satSet);
//
//   }  // End of method 'satOrbitMap::extractSatID()'
//
//
//
//      // Returns a satOrbitMap with only one satellite, identified
//      // by the given parameters.
//      // @param p Satellite PRN number.
//      // @param p System the satellite belongs to.
//   satOrbitMap satOrbitMap::extractSatID( const int& p,
//                                        const SatID::SatelliteSystem& s) const
//   {
//
//      SatID tempSatellite(p, s);  // We build a temporary SatID object
...
//
//
//      // Returns a satOrbitMap with only these satellites.
//      // @param satSet Set (SatIDSet) containing the satellites to
//      //               be extracted.
//   satOrbitMap satOrbitMap::extractSatID(const SatIDSet& satSet) const
//   {
//
//      satOrbitMap soMap;
//
...
//           ++pos )
//      {
//         satOrbitMap::const_iterator itObs( (*this).find(*pos) );
//         if( itObs != (*this).end() )
//         {
//            soMap[ (*itObs).first ] = (*itObs).second;
//         };
//      }
//
//      return soMap;
...
//      // Modifies this object, keeping only this satellite.
//      // @param satellite Satellite to be kept.
//   satOrbitMap& satOrbitMap::keepOnlySatID(const SatID& satellite)
//   {
//
//      SatIDSet satSet;
//      satSet.insert(satellite);
...
//      return keepOnlySatID(satSet);
//
//   }  // End of method 'satOrbitMap::keepOnlySatID()'
//
//
//
//      // Modifies this object, keeping only this satellite.
//      // @param p Satellite PRN number.
//      // @param p System the satellite belongs to.
//   satOrbitMap& satOrbitMap::keepOnlySatID( const int& p,
//                                            const SatID::SatelliteSystem& s )
//   {
//
//      SatID tempSatellite(p, s);  // We build a temporary SatID object
...
//      // Modifies this object, keeping only these satellites.
//      // @param satSet Set (SatIDSet) containing the satellites to be kept.
//   satOrbitMap& satOrbitMap::keepOnlySatID(const SatIDSet& satSet)
//   {
//
//      satOrbitMap soMap( extractSatID(satSet) );
//      (*this) = soMap;
//
//      return (*this);
//
...
//      // @param satSet Set (SatIDSet) containing the satellites
//      //               to be removed.
//   satOrbitMap& satOrbitMap::removeSatID(const SatIDSet& satSet)
//   {
//
//      for( SatIDSet::const_iterator pos = satSet.begin();
//           pos != satSet.end();
...
//      return (*this);
//
//   }  // End of method 'satOrbitMap::removeSatID()'
//
//
//
//      // Returns a reference to the typeValueMap with corresponding SatID.
//      // @param type Type of value to be looked for.
//   Vector<double>& satOrbitMap::operator()(const SatID& satellite)
//      throw(SatIDNotFound)
//   {
//
//      satOrbitMap::iterator itObs( (*this).find(satellite) );
//      if( itObs != (*this).end() )
//      {
//         return (*itObs).second;
//      }
...
//      }
//
//   }  // End of method 'satOrbitMap::operator()'
...
//      // Convenience output method for structure satOrbitMap
//   std::ostream& satOrbitMap::dump( std::ostream& s ) const
//   {
//
//      for( satOrbitMap::const_iterator it = (*this).begin();
//           it!= (*this).end();
...
//         s << endl;
//
//      }  // End of 'for( satOrbitMap::const_iterator it = ...'
//
//         // Let's return the 'std::ostream'
//      return s;
//
//   }  // End of method 'satOrbitMap::dump()'
...
//      // stream output for satOrbitMap
//   std::ostream& operator<<( std::ostream& s,
//                             const satOrbitMap& soMap )
//   {
//
//       soMap.dump(s);
//       return s;
